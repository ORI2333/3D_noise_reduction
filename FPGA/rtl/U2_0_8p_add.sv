...
module U2_0_8p_add #(
    ...
    reg                       [DATA_WIDTH: 0]         tmp_2      [1:0]      ;
    reg                       [DATA_WIDTH+1:0]        tmp_3      [1:0]      ;
    reg                       [         1: 0]         d_val                 ;
...
begin
    if (rst) begin
        ...
        if (i_dval) begin
            ...
            tmp_2[0]            <=              data_in4 + data_in5         ;
            tmp_2[1]            <=              data_in6 + data_in7         ; 
        end
        else begin
            tmp_1[0]            <=              'b0                         ;
            tmp_1[1]            <=              'b0                         ;
...
begin
    if (rst) begin
        ...
        if (d_val[0]) begin
            tmp_3[0]            <=              tmp_1[0]  + tmp_1[1]        ;
            tmp_3[1]            <=              tmp_2[0]  + tmp_2[1]        ;
        end else begin
            tmp_3[0]            <=              'b0                         ;
            tmp_3[1]            <=              'b0                         ;
        end
...
begin
    ...
    assign  data_out0            =              tmp_3[0]                    ;
    assign  data_out1            =              tmp_3[1]                    ;
    assign  o_dval               =              d_val[1]                    ;
