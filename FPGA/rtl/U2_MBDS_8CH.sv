...
module U2_MBDS_8CH #(
    ...
    input                                       data_valid                  ,//!鏁版嵁鏈夋晥淇″彿
    input                     [   7: 0]         data_in  [7: 0]             ,//!鏁版嵁杈撳叆

    output wire               [  11: 0]         MB_dout  [1:0]              ,//!瀹忓潡鏁版嵁杈撳嚭
    output wire                                 MB_ena                      ,//!瀹忓潡鏁版嵁鏈夋晥

    output wire               [  11: 0]         Sub_dout                    ,//!涓嬮噰鏍锋暟鎹緭锟???
    output wire                                 Sub_ena                     ,//!涓嬮噰鏍锋暟鎹湁锟???

    output wire                                 finish_flag                 ,//!锟??寮犲浘澶勭悊瀹屾垚
    input                                       flag_clr                     //!娓呴櫎绯荤粺鐘讹拷?
...
u_u_Sync_FIFO_FWFT(
    .clk                                       (clk                        ),// 系统时锟斤拷
    .rst                                       (rst | flag_clr             ),// 锟酵碉拷平锟斤拷效锟侥革拷位锟脚猴拷
    .data_in                                   (to_fifo[23:0]              ),// 写锟斤拷锟斤拷锟斤拷锟???
    .rd_en                                     (to_pixel4[20]              ),// 锟斤拷使锟斤拷锟脚号ｏ拷锟竭碉拷平锟斤拷效
    .wr_en                                     (to_fifo[24]                ),// 写使锟斤拷锟脚号ｏ拷锟竭碉拷平锟斤拷效
    .data_out                                  (fifo_to_pixel4             ) // 锟斤拷锟斤拷锟斤拷锟斤拷锟???
);
...
//---------------------------------------------------------------------------------------
    ...
    .clk                                       (clk                        ),// 系统时锟斤拷
    .rst                                       (rst | flag_clr             ),// 锟酵碉拷平锟斤拷效锟侥革拷位锟脚猴拷
    .data_in                                   (p2_to_fifo_mux[12:0]       ),// 写锟斤拷锟斤拷锟斤拷锟???
    .rd_en                                     (to_pixel2[13]              ),// 锟斤拷使锟斤拷锟脚号ｏ拷锟竭碉拷平锟斤拷效
    .wr_en                                     (p2_to_fifo_mux[13]         ),// 写使锟斤拷锟脚号ｏ拷锟竭碉拷平锟斤拷效
    .data_out                                  (fifo_to_pixel2             ) // 锟斤拷锟斤拷锟斤拷锟斤拷锟???
    );
