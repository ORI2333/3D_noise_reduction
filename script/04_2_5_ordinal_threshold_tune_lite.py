...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--shard_dir", type=str, default="script/train_oracle_dataset_v2_info")
    p.add_argument("--model_dir", type=str, default="script/out_train_ord_v2_lite/models")
    p.add_argument("--out_dir", type=str, default="script/out_ordinal_tune_v2_lite")
